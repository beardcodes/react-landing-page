    ...
    <div className="min-h-screen flex flex-col text-white">
        ...
        <main className="container mx-auto px-6 pt-16 flex-1 text-center">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-6xl uppercase">
            ...
            <h1 className="text-3xl md:text-6xl lg:text-8xl font-balck uppercase mb-8" >
              The coding club
          </h1>
          ...
          <form 
          action="https://www.getrevue.co/profile/elquaraoui/add_subscriber" 
          method="post"   
          target="_blank">
            ...
            By subscribing, you agree with Revue’s <a target="_blank" href="https://www.
            getrevue.co/terms" className="hover:opacity-80 duration-150">Terms of Service</a> and <a target="_blank" href="https:/
            /www.getrevue.co/privacy" className="hover:opacity-80 duration-150">Privacy Policy</a>.
            </div>
          </form>
